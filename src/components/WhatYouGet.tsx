      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="hidden md:block">
            <Button href="https://checkout.transacaoprotegida.com/0a94ad58-a8d6-4fef-b15a-dff429990b43" className="!bg-white !text-gray-950 !hover:bg-gray-100 shadow-none border-b-4 border-gray-300">
